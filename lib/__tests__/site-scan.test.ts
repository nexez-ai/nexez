...
describe('gatherSiteSignals', () => {
  ...
  it.each([
    ...
    ['Affordable, Reliable Web Hosting Solutions Web Hosting - courtesy of www.demo.example Awards --> Help Center Contact Us About Us Affiliates Terms &copy;2012 demo.example. All rights reserved.', 'unavailable_page'],
